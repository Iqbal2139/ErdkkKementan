    ...
    return {
        init: function () {
                ...
                r.validate().then(function (r) {
                    ...
                    setTimeout(function () {
                        ...
                        $.ajax({
                            url: "api/ganti-pass",
                            type: "post",
                            data: new FormData(document.getElementById("kt_new_password_form")),
                            processData: false,
                            contentType: false,
                                ...
                                if (data.status == '200') {
                                    ...
                                    .then(function (e) {
                                        if (e.isConfirmed) {
                                            ...
                                            (t.querySelector('[name="confirm-password"]',).value = ""),o.reset();
            ...
            : e.addEventListener("click", function (o) {
                ...
                r.revalidateField("password"),
                r.validate().then(function (r) {
                    "Valid" == r ? (e.setAttribute("data-kt-indicator", "on"),(e.disabled = !0),axios.post(
