    ...
    init: function () {
      (e = document.querySelector("#kt_modal_create_campaign")) &&
        ...
        n.addEventListener("click", function (e) {
            const formData = new FormData(document.getElementById("kt_modal_create_campaign_stepper_form"));

            $.ajax({
                url: 'api/pengajuan-store',
                data: formData,
                processData: false,
                contentType: false,
                type: 'POST',
                success: function(data){
                    console.log(data.message.dataSukses)

                    Swal.fire({
                        text: "Upload CSV berhasil",
                        icon: "success",
                        ...
                        if (result.isConfirmed) {
                            window.location = 'api/export-file-failed/?filename='+data.message.dataSukses+'';
                        }
                    });
